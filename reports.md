...
| DockerfileImageReport          | simple     | DockerfileImageCountReport   | 1                                 | The condensed version of the DockerfileImageReport dependency report                                               | false                                     | 0      |
| GHActionModuleReport           | dependency | GHActionModuleReport         | 1 per GHA module in org           | Which repos use a given GHA module.                                                                                | true                                      | 3      |
| GHActionModuleCountReport      | simple     | GHActionModuleCountReport    | 1                                 | The condensed version of the GHActionModule dependency report.                                                     | false                                     | 0      |
...
| NPMDependencyCountReport       | simple     | NPMDependencyCountReport     | 1                                 | The condensed version of the NPMDependency dependency report                                                       | false                                     | 0      |
...
| PIPDependencyCountReport       | simple     | PIPDependencyCountReport     | 1                                 | The condensed version of the PIPDependency report.                                                                 | false                                     | 0      |
...
| TerraformModuleCountReport     | simple     | TerraformModuleCountReport   | 1                                 | The condensed version of the TerraformModuleReport.                                                                | false                                     | 0      |
