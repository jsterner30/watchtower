...
| DockerfileImageReport          | dependency | DockerfileImageReport          | 1 per image in the org            | Which repos use a given image.                                                                                     | false                                     | 0      |
| DockerfileImageReport          | simple     | DockerfileImageCondensedReport | 1                                 | The condensed version of the DockerfileImageReport dependency report                                               | false                                     | 0      |
| GHActionModuleReport           | dependency | GHActionModuleReport           | 1 per GHA module in org           | Which repos use a given GHA module.                                                                                | false                                     | 0      |
| GHActionModuleCondensedReport  | simple     | GHActionModuleCondensedReport  | 1                                 | The condensed version of the GHActionModule dependency report.                                                     | false                                     | 0      |
| LicenseReport                  | simple     | LicenseReport                  | 1                                 | What licenses do repos with licenses use                                                                           | false                                     | 0      |
...
| NPMDependencyReport            | dependency | NPMDependencyReport            | 1 per npm dependency in the org   | Which repos use a given npm dependency.                                                                            | false                                     | 0      |
| NPMDependencyCondensedReport   | simple     | NPMDependencyCondensedReport   | 1                                 | The condensed version of the NPMDependency dependency report                                                       | false                                     | 0      |
...
| OpenAPIReport                  | simple     | OpenAPIReport                  | 1                                 | What repos have an OpenAPI file on their default branch                                                            | false                                     | 0      |
| PIPDependencyReport            | dependency | PIPDependencyReport            | 1 per pip dependency in the org   | Which repos use a given pip dependency.                                                                            | false                                     | 0      |
| PIPDependencyCondensedReport   | simple     | PIPDependencyCondensedReport   | 1                                 | The condensed version of the PIPDependency report.                                                                 | false                                     | 0      |
...
| PythonBranchVersionReport      | version    | PythonVersionReport            | 2                                 | Lowest and highest python versions on each branch in the org and the default branches of every repo in the org.    | false                                     | 0      |
| PythonRepoVersionReport        | version    | PythonVersionReport            | 1                                 | Lowest and highest python versions on every repo in the org, considering every branch in the org.                  | true                                      | 5      |
...
| TerraformModuleReport          | dependency | TerraformModuleReport          | 1 per terraform module in the org | Which repos use a given terraform module.                                                                          | false                                     | 0      |
| TerraformModuleCondensedReport | simple     | TerraformModuleCondensedReport | 1                                 | The condensed version of the TerraformModuleReport.                                                                | false                                     | 0      |
...
| OverallHealthScoreReport | OverallReports   | 1                                | A healthscore is assigned to each repo based on contributing repo reports. More info can be found in the "Overall Health Scoring" section of the README.md file. |
