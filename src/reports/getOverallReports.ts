...
export function getOverallReports (): OverallReports {
  return {
    ...
    overallHealthScoreReport: new OverallHealthScoreReport(0, 'OverallReports', 'A healthscore is assigned to each repo based on contributing repo reports. More info can be found in the "Overall Health Scoring" section of the README.md file.', '1', 'overall')
  }
}
