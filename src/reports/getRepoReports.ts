...
export function getRepoReports (): RepoReports {
  return {
    ...
    dockerfileImageReport: new DockerfileImageReport(0, 'DockerfileImageReport', 'Which repos use a given image.', '1 per image in the org', ReportType.DEPENDENCY),
    ...
    ghActionModuleReport: new GHActionModuleReport(0, 'GHActionModuleReport', 'Which repos use a given GHA module.', '1 per GHA module in org', ReportType.DEPENDENCY),
    ...
    npmDependencyReport: new NPMDependencyReport(0, 'NPMDependencyReport', 'Which repos use a given npm dependency.', '1 per npm dependency in the org', ReportType.DEPENDENCY),
    ...
    pipDependencyReport: new PIPDependencyReport(0, 'PIPDependencyReport', 'Which repos use a given pip dependency.', '1 per pip dependency in the org', ReportType.DEPENDENCY),
    ...
    terraformModuleReport: new TerraformModuleReport(0, 'TerraformModuleReport', 'Which repos use a given terraform module.', '1 per terraform module in the org', ReportType.DEPENDENCY),
